...
const contents = [
  [
    "01 / profile",
    "ものの見方",
    "観察して、ほどいて、もう一度組み立てる。日々の小さな違和感を手がかりに、ものと人の間にある形を探しています。",
  ],
  [
    "02 / tools",
    "道具箱",
    "手を動かすための、小さな道具たち。紙に描くことから、コードを組むことまで、考えを前へ進めるものを選びます。",
  ],
  [
    "03 / notes",
    "書き留める",
    "立ち止まったときに見つけたこと。余白のこと、歩く速さのこと、まだ言葉にならない発見を静かに残しています。",
  ],
  [
    "04 / contact",
    "声をかけて",
    "ここまで来たら、ぜひ一言。つくりたいものの話や、まだ輪郭のないアイデアも、ゆっくり聞かせてください。",
  ],
];
...
Promise.all(
  pawImages.map((paw) =>
    paw.decode ? paw.decode().catch(() => undefined) : Promise.resolve(),
  ),
).then(() =>
  setTimeout(() => {
    const title = document.querySelector(".title-section");
    const centeredPosition =
      title.offsetTop - (window.innerHeight - title.offsetHeight) / 2;
